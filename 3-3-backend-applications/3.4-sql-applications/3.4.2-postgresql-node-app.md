...
We'll write a command line app that mirrors the todo app we built in [2.PCE.6](../../2-2-backend-basics/2.poce-post-class-exercises/2.poce.6-todo-list-json.md), except with dogs.
