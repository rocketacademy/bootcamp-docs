...
Use an old Amazon EC2 Instance or create a new one following instructions in [2.11: AWS Deployment](../../2-2-backend-basics/2.11-deploy-server-to-cloud.md).
...
Log into our EC2 instance using SSH. See [2.11: AWS Deployment](../../2-2-backend-basics/2.11-deploy-server-to-cloud.md#ssh-log-in) for a refresher.
