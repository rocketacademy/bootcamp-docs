...
Add a repeated `newDeck.push(card);` line to `makeDeck` so that it outputs doubles of each card.
...
Fork and clone the [SWE Bootcamp Match Game repo](https://github.com/rocketacademy/match-game-bootcamp). Use code from the above implementation to build a working Match Game.
