...
Given the limited time for this exercise, begin by coding the top and bottom of the page before adding each middle section. Refer to the [cheatsheet](../../css/1.1.2-basic-css.md#exercise-tips-cheatsheet) to make the page easier to code.
