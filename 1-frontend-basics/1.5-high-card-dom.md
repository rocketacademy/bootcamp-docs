...
Now we'll determine how to display elements in the Game Info element we planned for at the start. 
...
When working with DOM \(HTML\) elements and visual output we'll also use a few principles to make our code easier to write:
