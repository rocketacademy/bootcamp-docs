...
module.exports = {
  up: async (queryInterface, Sequelize) => {
    await queryInterface.createTable('<TABLE_NAME_LOWER_CAMEL_CASE_PLURAL>', {
      id: {
        allowNull: false,
        autoIncrement: true,
        primaryKey: true,
  ...
  down: async (queryInterface, Sequelize) => {
    await queryInterface.dropTable('<TABLE_NAME_LOWER_CAMEL_CASE_PLURAL>');
  },
};
```
...
```javascript
export default function <MODEL_NAME_LOWER_CAMEL_CASE_SINGULAR>Model(sequelize, DataTypes) {
  return sequelize.define('<MODEL_NAME_LOWER_CAMEL_CASE_SINGULAR>', {
    id: {
      allowNull: false,
      autoIncrement: true,
      primaryKey: true,
...
import <MODEL_NAME_LOWER_CAMEL_CASE_SINGULAR>Model from './<MODEL_NAME_LOWER_CAMEL_CASE_SINGULAR>.mjs';
...
db.<MODEL_NAME_UPPER_CAMEL_CASE_SINGULAR> = <MODEL_NAME_LOWER_CAMEL_CASE_SINGULAR>Model(sequelize, Sequelize.DataTypes);
