...
Sequelize allows us to specify all attributes of our DB schema in JavaScript. We can then use Sequelize methods to generate and run queries for us, in lieu of raw SQL. This module is a summary of the core features of Sequelize and how to use them.
