...
module.exports = {
  up: async (queryInterface) => {
    ...
    queryInterface.bulkInsert('ItemsCategories', itemCategoryData);
    ...
    // Bulk insert carts
    const carts = await queryInterface.bulkInsert('Carts', cartData, {
      returning: true,
    });
...
The true power of Sequelize is the ability to access any model from any other model that is related through a chain of relationships. Typically we would do this sequentially, e.g. retrieve a
