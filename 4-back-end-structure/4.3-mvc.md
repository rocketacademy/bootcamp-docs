...
View refers to the UI of our application. We've already defined views in our `views` folder with our EJS files. MVC distinguishes between "application logic" and "view logic". Application logic determines how data should be calculated and stored. View logic determines how data should be presented, i.e. transforming data format without changing underlying value. Controllers typically contain application logic, and views typically contain view logic.
