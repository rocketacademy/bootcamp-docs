...
`useContext` is a technique that can be used when you don't want to pass props down your component hierarchy. It moves data between files and components the same way props do. Read about `useContext` in official React docs [here](https://reactjs.org/docs/hooks-reference.html#usecontext).
