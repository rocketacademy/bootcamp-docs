# 4.2.7: Sequelize Setup Cheatsheet

## [Setup Packages and Folders](4.2.1-intro-to-sequelize.md)
...
## [One-to-Many Associations](4.2.2-sequelize-one-to-many-relationships.md)
...
## [Many-to-Many Associations](4.2.4-sequelize-many-to-many.md)
