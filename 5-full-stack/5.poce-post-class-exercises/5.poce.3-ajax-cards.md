...
| :--- | :--- | :--- | :--- |
| id | SERIAL PRIMARY KEY | ID | 1 |
| drawPile | JSON | JSON array containing the cards remaining in the draw pile. | `[{...}, {...}, ...]` |
| discardPile | JSON | JSON array containing the cards that have been discarded from past games. | `[{...}, {...}, ...]` |
