...
3. Update the app to render item descriptions.
4. Add CSS to hide descriptions by default.
5. Add a button for each description.
6. Add client-side JavaScript so that button clicks will show the relevant description in a modal.
7. Render a button in each modal to dismiss the modal.
