...
* [0.0: Module 0 Overview](language-and-tooling/0.0-module-0-overview.md)
* [0.1: New JS Syntax](language-and-tooling/0.1-new-js-syntax.md)
* [0.2: ES6](language-and-tooling/0.2-es6/README.md)
...
* [0.5: Advanced Git](language-and-tooling/0.5-advanced-git/README.md)
...
* [0.8: JS Promises](language-and-tooling/0.8-js-promises/README.md)
...
* [0.9: VSCode Node Debugger](language-and-tooling/0.9-node-debugger.md)
* [0.ICE: In-Class Exercises](language-and-tooling/0.ice-in-class-exercises/README.md)
  * [0.ICE.1: Git Branches](language-and-tooling/0.ice-in-class-exercises/0.ice.1-git-branches.md)

## 1 Frontend Basics

* [1.0: Module 1 Overview](frontend-basics/1.0-module-1-overview.md)
* [1.1: HTML](frontend-basics/1.1-html/README.md)
  * [1.1.0: Wireframes](frontend-basics/1.1-html/1.1.0-wireframes.md)
  * [1.1.1: Basic HTML](frontend-basics/1.1-html/1.1.1-basic-html.md)
* [1.2: DOM Review](frontend-basics/1.2-dom-review/README.md)
  * [1.2.1: Creating Elements](frontend-basics/1.2-dom-review/1.2.1-creating-elements.md)
  * [1.2.2: Events](frontend-basics/1.2-dom-review/1.2.2-events.md)
  * [1.2.3: Grab an Element](frontend-basics/1.2-dom-review/1.2.3-grab-an-element.md)
...
* [1.ICE: In-Class Exercises](frontend-basics/1.ice-in-class-exercises/README.md)
...
* [1.POCE: Post-Class Exercises](frontend-basics/1.poce-post-class-exercises/README.md)
...
* [2.0: Module 2 Overview](backend-basics/2.0-module-2-overview.md)
...
* [2.13: JSON](backend-basics/2.13-json/README.md)
...
* [2.ICE: In-Class Exercises](backend-basics/2.ice-in-class-exercises/README.md)
...
* [2.POCE: Post-Class Exercises](backend-basics/2.poce-post-class-exercises/README.md)
  ...
  * [2.POCE.6: To-Do List - JSON DB](backend-basics/2.poce-post-class-exercises/2.poce.6-todo-list-json.md)

## 3 Backend Applications

* [3.0: Module 3 Overview](backend-applications/3.0-module-3-overview.md)
* [3.1: Express.js](backend-applications/3.1-express-js/README.md)
...
* [3.2: EJS](backend-applications/3.2-ejs/README.md)
...
* [3.3: SQL Language](backend-applications/3.3-sql-language/README.md)
  ...
  * [3.3.7: Self-Referencing Foreign Keys](backend-applications/3.3-sql-language/3.3.7-self-referencing-foreign-keys.md)
* [3.4: SQL Applications](backend-applications/3.4-sql-applications/README.md)
...
* [3.5: Authentication](backend-applications/3.5-authentication/README.md)
...
* [3.6: Heroku](backend-applications/3.6-heroku/README.md)
...
* [3.ICE: In-Class Exercises](backend-applications/3.ice-in-class-exercises/README.md)
  ...
  * [3.ICE.6: Inner Join](backend-applications/3.ice-in-class-exercises/3.ice.6-inner-join.md)
...
* [3.POCE: Post-Class Exercises](backend-applications/3.poce-post-class-exercises/README.md)
  ...
  * [3.POCE.4: SQL Meal Tracker](backend-applications/3.poce-post-class-exercises/3.poce.4-sql-meal-keeper.md)
...
* [4.0: Module 4 Overview](backend-structure/4.0-module-4-overview.md)
* [4.1: ORM, Sequelize](backend-structure/4.1-orm-sequelize/README.md)
  * [4.1.1: Intro to Sequelize](backend-structure/4.1-orm-sequelize/4.1.1-intro-to-sequelize.md)
  * [4.1.2: Sequelize One-to-Many Relationships](backend-structure/4.1-orm-sequelize/4.1.2-sequelize-one-to-many-relationships.md)
  ...
  * [4.1.6: Sequelize Constraints and Validations](backend-structure/4.1-orm-sequelize/4.1.6-sequelize-validations.md)
  * [4.1.7: Sequelize Eager Loading](backend-structure/4.1-orm-sequelize/4.1.7-sequelize-eager-loading.md)
  * [4.1.8: Multiple Foreign Key Columns Referencing Same Table](backend-structure/4.1-orm-sequelize/4.1.8-multiple-foreign-key-columns-referencing-same-table.md)
  * [4.1.9: Sequelize Setup Cheatsheet](backend-structure/4.1-orm-sequelize/4.1.9-sequelize-setup-cheatsheet.md)
  * [4.1.10: Deploy Sequelize App to Heroku](backend-structure/4.1-orm-sequelize/4.1.10-deploy-sequelize-app-to-heroku.md)
* [4.2: MVC](backend-structure/4.2-mvc/README.md)
  * [4.2.1: RESTful Routes](backend-structure/4.2-mvc/4.2.1-restful-routes.md)
* [4.ICE: In-Class Exercises](backend-structure/4.ice-in-class-exercises.md)
* [4.POCE: Post-Class Exercises](backend-structure/4.poce-post-class-exercises/README.md)
...
* [5.0: Module 5 Overview](full-stack-applications/5.0-module-5-overview.md)
* [5.1: DOM Manipulation with Express App](full-stack-applications/5.1-dom-manipulation-with-express-app.md)
* [5.2: AJAX](full-stack-applications/5.2-ajax/README.md)
...
* [5.ICE: In-Class Exercises](full-stack-applications/5.ice-in-class-exercises/README.md)
...
* [5.POCE: Post-Class Exercises](full-stack-applications/5.poce-post-class-exercises/README.md)
...
* [6.0: Module 6 Overview](frontend-infrastructure/6.0-module-6-overview.md)
* [6.1: Webpack](frontend-infrastructure/6.1-webpack/README.md)
...
* [6.ICE: In-Class Exercises](frontend-infrastructure/6.ice-in-class-exercises/README.md)
  * [6.ICE.1: NPM Webpack](frontend-infrastructure/6.ice-in-class-exercises/6.ice.1-npm-webpack.md)

## 7 React

* [7.0: Module 7 Overview](react/7.0-module-7-overview.md)
* [7.1: JSX Intro](react/7.1-jsx-intro/README.md)
...
* [7.2: React Components](react/7.2-react-components/README.md)
...
* [7.7: Designing Component Hierarchy](react/7.7-designing-component-hierarchy/README.md)
...
* [7.ICE: In-Class Exercises](react/7.ice-in-class-exercises/README.md)
  * [7.ICE.1: Product Rendering](react/7.ice-in-class-exercises/7.ice.1-product-rendering.md)
  * [7.ICE.2: Pokedex](react/7.ice-in-class-exercises/7.ice.2-pokedex.md)
...
* [7.POCE: Post-Class Exercises](react/7.poce-post-class-exercises/README.md)
  * [7.POCE.1: Bugs](react/7.poce-post-class-exercises/7.poce.1-bugs.md)
...
* [8.0: Module 8 Overview](advanced-react/8.0-module-8-overview.md)
* [8.1: Create React App](advanced-react/8.1-create-react-app/README.md)
  * [8.1.1: Create React App Full Stack Setup](advanced-react/8.1-create-react-app/8.1.1-create-react-app-full-stack-setup.md)
  * [8.1.2: CRA Deployment](advanced-react/8.1-create-react-app/8.1.2-cra-deployment.md)
* [8.2: Higher-Order Components](advanced-react/8.3-higher-order-components.md)
* [8.3: Advanced State](advanced-react/8.2-usecontext/README.md)
...
* [8.4: React Router](advanced-react/8.4-react-router/README.md)
...
* [8.9: React State Management](advanced-react/8.9-react-state-management.md)
* [8.ICE: In-Class Exercises](advanced-react/8.ice-in-class-exercises/README.md)
  * [8.ICE.1: useContext](advanced-react/8.ice-in-class-exercises/8.ice.1-usecontext.md)
* [8.POCE: Post-Class Exercises](advanced-react/8.poce-post-class-exercises/README.md)
  * [8.POCE.1: Car Rental](advanced-react/8.poce-post-class-exercises/8.poce.1-car-rental.md)
  * [8.POCE.2: (Group Project) Rock Climbing Trip Planner](advanced-react/8.poce-post-class-exercises/8.poce.2-rock-climbing-trip-planner.md)

## 9 Advanced Topics

* [9.0: Module 9 Overview](advanced-topics/9.0-module-9-overview.md)
* [9.1: Testing](advanced-topics/9.1-testing/README.md)
...
* [9.2: Security](advanced-topics/9.2-security/README.md)
...
* [9.3: Django](advanced-topics/9.3-django/README.md)
...
* [9.5: ML - Bayes Theorem](advanced-topics/9.5-ml-bayes-theorem/README.md)
  * [9.5.1: ML- Naive Bayes Classifier - JavaScript](advanced-topics/9.5-ml-bayes-theorem/9.5.1-ml-naive-bayes-classifier-javascript.md)
  * [9.5.2: ML - Naive Bayes Classifier - Python](advanced-topics/9.5-ml-bayes-theorem/9.5.2-ml-naive-bayes-classifier-python.md)
* [9.6: GraphQL / React-Apollo](advanced-topics/9.6-graphql-react-apollo.md)
* [9.7: Web Sockets](advanced-topics/9.7-web-sockets.md)
* [9.8: CSS Animations](advanced-topics/9.8-css-animations.md)
* [9.ICE: In-Class Exercises](advanced-topics/9.ice-in-class-exercises/README.md)
  * [9.ICE.1: Unit Testing](advanced-topics/9.ice-in-class-exercises/9.ice.1-unit-testing.md)
  * [9.ICE.2: TDD](advanced-topics/9.ice-in-class-exercises/9.ice.2-tdd.md)
* [9.POCE: Post-Class Exercises](advanced-topics/9.poce-post-class-exercises/README.md)
  * [9.POCE.1: Django App](advanced-topics/9.poce-post-class-exercises/9.poce.1-django-app.md)
