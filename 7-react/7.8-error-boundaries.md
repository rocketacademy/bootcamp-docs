  ...
  render() {
    ...
    return (
      <div>
        ...
        <p><button onClick={this.increment}>add one to count</button></p>
      </div>
    );
  }
}
...
This repo has a React app with no Fast Refresh or dev server: [https://github.com/rocketacademy/react-error-boundary-swe1](https://github.com/rocketacademy/react-error-boundary-swe1)

Inside is a component that will throw a runtime React rendering error.

[https://github.com/rocketacademy/react-error-boundary-swe1/blob/main/src/App.jsx](https://github.com/rocketacademy/react-error-boundary-swe1/blob/main/src/App.jsx)
...
[https://github.com/rocketacademy/react-error-boundary-swe1/tree/error-b](https://github.com/rocketacademy/react-error-boundary-swe1/tree/error-b)

See the diff here: [https://github.com/rocketacademy/react-error-boundary-swe1/compare/f382006376b6787fa759509d0fe931d2383ba8df..215522db9a25df2f216502ad1ccb985c78cd6d8c?diff=split](https://github.com/rocketacademy/react-error-boundary-swe1/compare/f382006376b6787fa759509d0fe931d2383ba8df..215522db9a25df2f216502ad1ccb985c78cd6d8c?diff=split)
