...
Begin by making a branch `3-poce-5` to record the state of your code in the [Bird Watching repo from 3.POCE.5](https://github.com/rocketacademy/birding-express-bootcamp). Start 3.POCE.6 by modifying the `main` branch after saving your previous code in the `3-poce-5` branch.
