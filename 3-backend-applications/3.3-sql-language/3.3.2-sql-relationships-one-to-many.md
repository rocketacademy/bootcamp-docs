...
![In this example, categories is the "one" table and recipes is the "many". Each category can have many recipes. Each recipe belongs to at most 1 category.](<../../.gitbook/assets/One-to-many (1).jpg>)
