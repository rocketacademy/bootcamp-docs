...
{% hint style="warning" %}
Above is the general SQL syntax for table creation. In succeeding lessons, we will be using PostgreSQL, where the type declaration for primary key is slightly different.
{% endhint %}
