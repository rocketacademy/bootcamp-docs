...
This module contains common SQL commands that we will execute in SQL command line environments and our apps. To test the queries in this module, see the environment referenced in the [Exercise section](3.3.1-basic-sql-commands.md#exercise).
