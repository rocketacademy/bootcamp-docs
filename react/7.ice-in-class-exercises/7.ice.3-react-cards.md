...
2. Copy `shuffleCards` and `makeDeck` functions from [Module 1.5: High Card setTimeout](../../frontend-basics/1.3-high-card-dom.md) and paste them into the `App.jsx` file (or create a module for them).
