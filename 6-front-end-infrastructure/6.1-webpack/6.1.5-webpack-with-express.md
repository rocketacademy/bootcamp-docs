...
The instructions in this module will refer to the `webpack-mvc-base-swe1` example repo [here](https://github.com/rocketacademy/webpack-mvc-base-swe1/tree/full-example). There are two branches in this repo. `main` contains the base starter code, and `full-example` contains a full app with migrations and seed. We will be referring to the `full-example` branch.
