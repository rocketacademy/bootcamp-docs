...
No need to worry for now how JavaScript manages to keep track and manage these values for use in an object or array. We'll cover the topic regarding objects in [DS&A D.6.2: Hash Tables](../../data-structures-and-algorithms/d.5-data-structures/d.5.2-hash-tables/).
