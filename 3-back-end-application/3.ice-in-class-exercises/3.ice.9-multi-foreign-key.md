...
Create a command-line app for an art museum. The museum curators develop collections for paintings to be part of. Collection names can reflect their school, art movement, years, or donors. For example, a collection might have the name "New York School" and contain 2 paintings. A painting is credited to a single artist, and can only be part of 1 collection at a time. 
