...
For each route specified in the previous exercise, create an EJS HTML file for it.
...
On the main list page, create a series of links for each parameter in the sighting \(except for the very big parameter, "OBSERVED"\).
