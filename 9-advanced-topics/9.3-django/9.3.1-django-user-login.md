...
User auth in Django is 100% built-in. We'll follow through the steps needed to use this part of the library.

## Setup

#### django-extensions

django-extensions is a popular add-on to Django that includes a variety of functionality. We will use it to gather more information on the command line, but it does a lot of different things.
...
The error will be about a missing template file.
...
Decorators are a syntax to call something like a helper function in Python.

Learn more [about decorators here.](https://www.geeksforgeeks.org/decorators-in-python/)
