...
#### Time Complexity Example: Find the median element in a sorted array
...
#### Time Complexity Example: Find the element with value `x` in a sorted array
...
#### Time Complexity Example: Find the largest number in an unsorted array
...
#### Time Complexity Example: Sort an unsorted array of numbers
...
#### Time Complexity Example: Find all pairs of numbers in an array
...
#### Time Complexity Example: Calculate the n-th Fibonacci Number
