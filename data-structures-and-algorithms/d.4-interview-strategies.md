...
More often than not we will end up with a flawed solution on our first try. The code may run but it fails our test cases. Instead of guessing where the bugs in our code may be, we must be methodical about testing. 
