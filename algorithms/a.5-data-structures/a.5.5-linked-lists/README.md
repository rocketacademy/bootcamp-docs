...
1. [https://repl.it/@rocketkai/singly-linked-list](https://repl.it/@rocketkai/singly-linked-list)
   1. [https://repl.it/@rocketkai/singly-linked-list-soln](https://repl.it/@rocketkai/singly-linked-list-soln)
   2. [FTBC3 class video](https://youtu.be/qewAXA_vkpE?t=2004) where we covered the 1st 2 problems (re-recorded after class)

### Part 1

1. [https://repl.it/@rocketkai/doubly-linked-list](https://repl.it/@rocketkai/doubly-linked-list)
   1. [https://repl.it/@rocketkai/doubly-linked-list-soln](https://repl.it/@rocketkai/doubly-linked-list-soln)
2. [https://repl.it/@rocketkai/circular-doubly-linked-list](https://repl.it/@rocketkai/circular-doubly-linked-list)
   1. [https://repl.it/@rocketkai/circular-doubly-linked-list-soln](https://repl.it/@rocketkai/circular-doubly-linked-list-soln)
