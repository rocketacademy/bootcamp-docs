...
```text
git clone https://github.com/rocketacademy/file-server-example-bootcamp
```
...
Test it by requesting the server at your IP address. It should look something like [http://&lt;MY\_EC2\_IP\_\_\_ADDRESS&gt;/index.html](http://<MY_EC2_IP___ADDRESS>/index.html).
