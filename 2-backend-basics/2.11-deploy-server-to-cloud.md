...
2. Move your SSH key pair to your `~/.ssh` folder in your Unix filesystem. This is the standard place to store SSH keys. For WSL users, see a past student Porter's notes [here](https://www.notion.so/Where-to-put-the-SSH-key-For-windows-1565ad330b12412bbe5036372a1b21a4).
