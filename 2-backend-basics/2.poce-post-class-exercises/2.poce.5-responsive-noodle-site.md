...
We will upgrade the Noodle site we built in [1.POCE.1: Noodle Recipe Website](../../1-frontend-basics/1.poce.css-post-class-css-exercises/1.poce.css.1-noodles.md) with responsive layouts.
...
In [1.POCE.1: Noodle Recipe Website](../../1-frontend-basics/1.poce.css-post-class-css-exercises/1.poce.css.1-noodles.md) we created 3 types of pages.
