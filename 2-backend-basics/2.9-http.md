...
**We always use asynchronous code when requesting and receiving data from the Internet**, so that our programs do not hang while waiting for data, which could take an indefinite amount of time.
