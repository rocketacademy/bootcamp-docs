...
Node.js always interfaces with our computer asynchronously. This is because of the relative "distance" and "speed" of parts of our computer such as RAM or hard drive. We do not necessarily want our programs to wait for data to return from parts of our computer that are "far away" or "slower". We elaborate on this in the Internet Latency section below.
