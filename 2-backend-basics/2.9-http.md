...
![Retrieving data over 4G is like a round-trip to Saturn compared with retrieving data locally.](<../.gitbook/assets/My document (2) (1).jpg>)
...
![Our computer hardware simulates that requests to localhost come from outside.](<../.gitbook/assets/My document (8) 2 (1).jpg>)
