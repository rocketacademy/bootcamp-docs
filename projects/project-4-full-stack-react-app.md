...
| :--- | :--- |
| CD14.1 | Ideation Phase 1. Introduce Project 4, post project ideas in Slack for feedback |
...
| CD16.1 | Finish core functionality \(MVP\). Users should be able to perform the primary user story. Please deploy your app to Heroku before feature freeze on Thursday. 30-minute mid-point check-in with instructor. |
