...
You are connected via SSH, which means that whatever you type on your own computer gets sent directly to the AWS computer \(specifically keystroke by keystroke\).
