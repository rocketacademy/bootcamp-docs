...
TCP/IP ports were originally intended to designate an entirely separate protocol per port, but today many different applications can use HTTP, but on different ports.
