...
| SSD Hard Drive | Databases, files. | 0.00015 seconds | 150km | Halfway to the moon. | 10³ |
| LAN Network | Networked DB access from a computer nearby. | 0.15 seconds | 150,000,000km | Twice the distance to Mars. | 10⁸ |
| 4G Mobile Network | Downloading something on a mobile device. | 1 second | 1,000,000,000km | Not quite to Saturn. | 10⁹ |
